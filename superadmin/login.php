...
<head>
    ...
    <title>Super Admin Login - John Hay Hotels</title>
    ...
    <div class="relative z-10 w-full max-w-md px-6">
        <div class="text-center mb-10 fade-up">
            ...
            <div class="flex items-center justify-center gap-3">
                ...
                <span class="text-gold-400/70 text-[0.6rem] font-semibold tracking-[0.3em] uppercase">Super Admin</span>
                <span class="w-10 h-px bg-gold-400/40"></span>
            </div>
        </div>
        <div class="glass-card rounded-2xl p-8 fade-up" style="animation-delay: 0.2s;">
            <div class="text-center mb-8">
                ...
                <h2 class="font-serif text-xl text-white/80 tracking-wide">Super Admin Access</h2>
                <p class="text-white/30 text-xs mt-2">Manage administrator accounts</p>
            </div>
            <?php if ($error): ?>
            ...
            <form method="POST" class="space-y-5">
                <div>
                    ...
                    <input type="text" name="username" required autofocus placeholder="Enter super admin username" class="lodge-input">
                </div>
                <div>
