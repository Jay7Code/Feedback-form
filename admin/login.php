    ...
    <style>
        ...
        .scene-bg::after {
            ...
            background: linear-gradient(180deg,
                rgba(10,25,18,0.7) 0%, rgba(10,25,18,0.5) 50%, rgba(10,25,18,0.8) 100%);
        }
        .glass-card {
            background: rgba(245,235,224,0.08);
            backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px);
            border: 1px solid rgba(201,169,110,0.15);
            box-shadow: 0 8px 32px rgba(0,0,0,0.3), inset 0 1px 0 rgba(201,169,110,0.1);
        }
        .lodge-input {
...
<body class="font-sans min-h-screen flex items-center justify-center text-white relative">
    ...
    <div class="relative z-10 w-full max-w-md px-6">
        ...
        <div class="glass-card rounded-2xl p-8 fade-up" style="animation-delay: 0.2s;">
            ...
            <?php if ($error): ?>
                <div class="bg-red-900/20 border border-red-400/20 rounded-xl px-4 py-3 mb-6 text-center">
                    <p class="text-red-400/80 text-sm"><?= htmlspecialchars($error) ?></p>
                </div>
            <?php endif; ?>
            ...
            <form method="POST" class="space-y-5">
                ...
                <button type="submit"
                        class="w-full py-3.5 rounded-full font-semibold text-sm uppercase tracking-[0.15em] transition-all duration-300 hover:shadow-lg"
        ...
        <p class="text-center text-white/15 text-[0.6rem] uppercase tracking-[0.3em] mt-8 fade-up" style="animation-delay: 0.4s;">
