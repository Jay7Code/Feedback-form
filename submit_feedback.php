 ...
 * 2. Collects and sanitizes all form data
 * 3. Saves the feedback to the MySQL database
 * 4. Displays a themed "Thank You" or error page
 * ═══════════════════════════════════════════════════════════════
 */
...
try {
    ...
    $sql = "INSERT INTO feedbacks (
        ...
        accommodation, safety, security, overall_service, frontdesk_comments,
        food_quality, serving_time, wait_staff, grooming, behavior,
...
<head>
    ...
    <title>Thank You - John Hay Hotels | Forest Wing</title>
    ...
    <!-- Tailwind Config (matching index.php theme) -->
    <script>
        tailwind.config = {
            theme: {
                extend: {
    ...
    <style>
        ...
        .scene-bg::after {
            ...
            background: linear-gradient(180deg,
                rgba(10,25,18,0.6) 0%, rgba(10,25,18,0.4) 50%, rgba(10,25,18,0.7) 100%);
        }
        @keyframes checkDraw { 0% { stroke-dashoffset: 48; } 100% { stroke-dashoffset: 0; } }
        .check-animated { stroke-dasharray: 48; stroke-dashoffset: 48; animation: checkDraw 0.6s 0.4s ease-out forwards; }
        @keyframes scaleIn { 0% { transform: scale(0); } 100% { transform: scale(1); } }
        .scale-animated { animation: scaleIn 0.4s cubic-bezier(0.34,1.56,0.64,1) forwards; }
        ...
        <div class="max-w-lg w-full text-center">
            ...
            <?php if ($success): ?>
                <div class="w-24 h-24 mx-auto mb-8 rounded-full flex items-center justify-center scale-animated"
                     style="background:linear-gradient(135deg,#C9A96E,#b5893a)">
            ...
            <?php else: ?>
                ...
                <a href="index.php" class="inline-flex items-center gap-2 px-8 py-3 rounded-full font-semibold text-sm uppercase tracking-wider transition-colors"
                   style="background:linear-gradient(135deg,#C9A96E,#b5893a);color:#0A1912">Try Again</a>
            <?php endif; ?>
        </div>
    </main>
