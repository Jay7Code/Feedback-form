...
<head>
    ...
    <style>
        ...
        .particle-1 { width: 3px; height: 3px; background: rgba(201,169,110,0.50); top: 20%; left: 15%; animation: float1  8s ease-in-out infinite; }
        .particle-2 { width: 2px; height: 2px; background: rgba(201,169,110,0.30); top: 45%; left: 80%; animation: float2 12s ease-in-out infinite; }
        .particle-3 { width: 4px; height: 4px; background: rgba(201,169,110,0.20); top: 70%; left: 25%; animation: float3 10s ease-in-out infinite; }
        .particle-4 { width: 2px; height: 2px; background: rgba(201,169,110,0.40); top: 35%; left: 60%; animation: float1 14s ease-in-out infinite 2s; }
        .particle-5 { width: 3px; height: 3px; background: rgba(201,169,110,0.25); top: 60%; left: 45%; animation: float2  9s ease-in-out infinite 1s; }
        .particle-6 { width: 2px; height: 2px; background: rgba(201,169,110,0.35); top: 15%; left: 70%; animation: float3 11s ease-in-out infinite 3s; }
        ...
        @keyframes float2 {
            0%, 100% { transform: translate(0,0) scale(1); opacity: 0; }
            15% { opacity: 1; }
            50% { transform: translate(-20px,-50px) scale(1.3); opacity: 0.5; }
            85% { opacity: 1; }
        }
        @keyframes float3 {
            0%, 100% { transform: translate(0,0) scale(1); opacity: 0; }
            20% { opacity: 0.8; }
            50% { transform: translate(40px,-30px) scale(1.8); opacity: 0.4; }
            80% { opacity: 0.8; }
        }
        ...
        .nps-radio:checked + .nps-btn {
            ...
            border-color: transparent; color: #0A1912;
            transform: translateY(-3px);
        ...
        .lodge-input:focus {
            border-color: #C9A96E; background: rgba(255,255,255,0.1);
        ...
        @keyframes glow    { 0%, 100% { box-shadow: 0 0 20px rgba(201,169,110,0.1); } 50% { box-shadow: 0 0 40px rgba(201,169,110,0.2); } }
    ...
    <div class="relative z-10">
        ...
        <header class="relative py-20 md:py-28 text-center overflow-hidden">
            <div class="relative z-10 px-6">
                ...
                <div class="w-20 h-px bg-gradient-to-r from-transparent via-gold-400/50 to-transparent mx-auto mb-8 animate-shimmer"></div>
                ...
                <!-- Diamond divider -->
                <div class="flex items-center justify-center gap-4 mb-10 animate-fade-up" style="animation-delay: 0.45s;">
                ...
                <!-- Intro message card -->
                <div class="glass-card rounded-2xl px-8 py-6 max-w-xl mx-auto animate-fade-up" style="animation-delay: 0.6s;">
                ...
                <section class="reveal-section glass-card-warm rounded-2xl overflow-hidden">
                    ...
                    <div class="px-6 py-8">
                        <p class="text-sm font-medium text-white/60 mb-8 text-center">
                            Based on your experience, how satisfied are you with your stay? <span class="text-red-400">*</span>
                        </p>
